...
extension ViewController {
    ...
    private func configureSearchBar() {
        ...
        //navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Add", style: .plain, target: self, action: #selector(barButtonItemPressed))
    }
}
